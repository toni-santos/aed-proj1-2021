 ...
 * @return A vector of all the words in str that were separated by the character i.
 */
 ...
 * @return An unsigned integer equal to the number of digits of a given number n.
 */
